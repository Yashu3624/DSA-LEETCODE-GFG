<h2><a href="https://leetcode.com/problems/sum-of-largest-prime-substrings/description/">3556. Sum of Largest Prime Substrings</a></h2><h3>Medium</h3><hr><p data-end="157" data-start="30">Given a string <code>s</code>, find the sum of the <strong>3 largest unique prime numbers</strong> that can be formed using any of its<strong> substrings</strong>.</p>
