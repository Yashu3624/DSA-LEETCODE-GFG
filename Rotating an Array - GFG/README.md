# Rotating an Array
## Easy
<div class="problems_problem_content__Xm_eO cursor-hover"><p class="cursor-hover"><span style="font-size: 18px;" class="cursor-hover">Given an array&nbsp;of size&nbsp;<strong>N</strong>. The task is to rotate array by <strong>D</strong> elements where <strong>D&nbsp;</strong></span><span style="font-size: 18px;">≤</span><span style="font-size: 18px;">&nbsp;<strong>N</strong>.</span></p>
<p class="cursor-hover"><span style="font-size: 18px;"><strong>Example 1:</strong></span></p>
...
<p class="cursor-hover"><br><span style="font-size: 18px;"><strong>Example 2:</strong></span></p>
<pre class="cursor-hover"><span style="font-size: 18px;"><strong>Input:
</strong>N = 4
Arr[] = {1, 3, 4, 2}
D = 3
