# Excel Sheet | Part - 1
## Medium
<div class="problems_problem_content__Xm_eO"><p class="cursor-hover"><span style="font-size:18px" class="cursor-hover">Given a positive integer N, return&nbsp;its corresponding column title as it would appear in an Excel sheet.<br>
