...
## Easy
<div class="problems_problem_content__Xm_eO cursor-hover"><p class="cursor-hover"><span style="font-size: 14pt;" class="cursor-hover">Given a Binary Search Tree, modify the given BST such that it is balanced and has minimum possible height. Return the balanced BST.</span></p>
<p class="cursor-hover"><span style="font-size: 14pt;"><strong>Example1:</strong></span></p>
<pre class="cursor-hover"><span style="font-size: 14pt;"><strong>Input:</strong>
       30
      /
     20
    /
...
<p class="cursor-hover"><span style="font-size: 14pt;"><strong>Example2:</strong></span></p>
<pre class="cursor-hover"><span style="font-size: 14pt;"><strong>Input:</strong>
         4
        /
       3
