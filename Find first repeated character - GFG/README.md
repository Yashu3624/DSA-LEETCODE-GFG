...
## Easy
<div class="problems_problem_content__Xm_eO"><p class="cursor-hover"><span style="font-size: 18px;" class="cursor-hover">Given a string <strong>S</strong>. The task is to&nbsp;find the first repeated character in it. We need to find the character that occurs more than once and whose index of second occurrence is smallest. S contains only lowercase letters.</span></p>
<p>&nbsp;</p>
